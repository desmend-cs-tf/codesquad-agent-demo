...
// ── SOLUTION: Ingest all PDFs from docs/ folder ────────────────────────
...
// ── SOLUTION: Implement retrievalTool ──────────────────────────────────
...
// ── SOLUTION: Create agent with retrieval ──────────────────────────────
async function main() {
  console.log("=".repeat(60));
  console.log("RAG Classwork with PDFs - SOLUTION");
  console.log("=".repeat(60));
  ...
  const queries = [
    "Based on the documents I uploaded, summarize the main points and key concepts.",
    "What are the most important details from the documents?",
    "Please explain the key ideas from these documents with specific examples."
  ];

  for (const goal of queries) {
    console.log("\n" + "=".repeat(60));
